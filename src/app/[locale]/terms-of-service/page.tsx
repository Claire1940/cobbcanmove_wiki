...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Cobb Can Move Wiki",
    description: "Read the Terms of Service for Cobb Can Move Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our itch.io game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Cobb Can Move Wiki",
      description: "Terms and conditions for using Cobb Can Move Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Cobb Can Move Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Cobb Can Move Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Cobb Can Move Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Cobb Can Move Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the itch.io game "Cobb Can Move". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and survival strategies</li>
              <li>Rules and Cobb ability guides</li>
              <li>Objective and item guides</li>
              <li>Cobb ability and behavior guides</li>
              <li>Endings and update walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Cobb Can Move Wiki is NOT affiliated with, endorsed by, or associated with
              the developer abho or the official developers of Cobb Can Move. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Cobb Can Move Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of the developer abho and/or the itch.io platform. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> itch.io game availability and updates may change without notice. We are not responsible for game access or changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, COBB CAN MOVE WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Cobb Can Move Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@cobbcanmove.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@cobbcanmove.wiki</a>
            </p>
            <p>
