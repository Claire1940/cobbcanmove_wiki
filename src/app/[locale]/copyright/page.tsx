...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Cobb Can Move Wiki',
    description: 'Copyright and intellectual property information for Cobb Can Move Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Cobb Can Move Wiki',
      description: 'Copyright and intellectual property information for Cobb Can Move Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Cobb Can Move Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Cobb Can Move Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Cobb Can Move Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>itch.io</strong> - Operator of the itch.io platform</li>
              <li><strong>Cobb Can Move Developers</strong> - Creators of the Cobb Can Move game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>itch.io</strong> - Trademark of itch.io corp.</li>
              <li><strong>Cobb Can Move</strong> - Trademark of the game developers</li>
              <li><strong>Cobb Can Move Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Cobb Can Move Wiki.
            </p>
            ...
            <p>
              ...
              Cobb Can Move Wiki<br />
              Email: <a href="mailto:dmca@cobbcanmove.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cobbcanmove.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Cobb Can Move Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Cobb Can Move Wiki (cobbcanmove.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@cobbcanmove.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@cobbcanmove.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@cobbcanmove.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cobbcanmove.wiki</a>
            </p>
            <p>
